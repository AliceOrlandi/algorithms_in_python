...
# add nodes to the linked list
llist.insertAtEnd(MyData(1,'a','aa'))
llist.insertAtEnd(MyData(2,'b','bb'))
llist.insertAtBegin(MyData(3,'c','cc'))
llist.insertAtEnd(MyData(4,'d','dd'))
llist.insertAtIndex(MyData(5,'g','gg'), 2)
